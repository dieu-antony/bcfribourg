    ...
    <>
      ...
      <div className="flex h-full min-h-max w-full flex-col items-center justify-center pt-16">
        ...
        <div className="flex flex-col">
          <div className="max-w-[1000px] m-5 bg-gray-100 p-5">
            <h2 className="font-bold mb-2 bg-gradient-to-r from-picton-blue-600 to-picton-blue-500 bg-clip-text text-transparent">
              Accès à la salle
            </h2>
            <div>
              <p className="mb-4">
              ...
              <iframe
                ...
                className="aspect-video w-full justify-self-center border-0 mt-2"
              ></iframe>
              <p className="mt-4 mb-4">
              Ci-dessous, vous trouvez un plan détaillé du site lui-même (cliquez sur l'image pour agrandir).
              </p>
